...
with col_left:
    ...
    st.link_button("Visitar site do IFPB", "https://sites.google.com/academico.ifpb.edu.br/alan?usp=sharing")
    st.markdown("</div>", unsafe_allow_html=True)
...
st.markdown(f"""
    <div style="text-align: center; margin-top: 10px;">
        <a href="https://wa.me/5583991700421" target="_blank">
